...
test:
	...
	@if [ -f apps/strapi/package.json ] && npm --prefix apps/strapi run | grep -q " test"; then cd apps/strapi && VITE_CJS_IGNORE_WARNING=true npm test; else echo "No Strapi test script defined"; fi
